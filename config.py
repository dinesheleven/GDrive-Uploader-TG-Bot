...
class Config:
  ...
  if ENV:
    ...
    BOT_TOKEN = '1935127205:AAGVkPqttRKxObYmhq1A4Dk6QxUZqFGaBB4' # Get it from https://t.me/BotFather
    APP_ID = '5221390' # Get it from my.telegram.org/apps
    API_HASH = '81905a948f1801130e284086ac88f365' # Get it from my.telegram.org/apps
